...
import 'package:empty_aplicattion/View/home.dart';
import 'package:empty_aplicattion/View/register.dart';
                        ...
                        if(_formKey.currentState!.validate()){
                          if(dataForm!['email'] == emailController.text && dataForm['password'] == passwordController.text){
                            ...
                            showDialog(context: context, builder: (_)=>AlertDialog(
                              ...
                              content: TextButton(onPressed: () =>pushRegister(context), child: const Text('Daftar Disini !!')),
                            actions: <Widget>[
